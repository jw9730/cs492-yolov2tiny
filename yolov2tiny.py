    ...
    def build_graph(self, in_shape):
        ...
        with self.g.as_default():
            with tf.device('/'+self.proc):
                ...
                n0 = tf.nn.batch_normalization(x=b0, mean=moving_mean, variance=moving_variance, scale=gamma, variance_epsilon=bn_eps)
                ...
                n1 = tf.nn.batch_normalization(x=b1, mean=moving_mean, variance=moving_variance, scale=gamma, variance_epsilon=bn_eps)
                ...
                n2 = tf.nn.batch_normalization(x=b2, mean=moving_mean, variance=moving_variance, scale=gamma, variance_epsilon=bn_eps)
                ...
                n3 = tf.nn.batch_normalization(x=b3, mean=moving_mean, variance=moving_variance, scale=gamma, variance_epsilon=bn_eps)
                ...
                n4 = tf.nn.batch_normalization(x=b4, mean=moving_mean, variance=moving_variance, scale=gamma, variance_epsilon=bn_eps)
                ...
                n5 = tf.nn.batch_normalization(x=b5, mean=moving_mean, variance=moving_variance, scale=gamma, variance_epsilon=bn_eps)
                ...
                n6 = tf.nn.batch_normalization(x=b6, mean=moving_mean, variance=moving_variance, scale=gamma, variance_epsilon=bn_eps)
                ...
                n7 = tf.nn.batch_normalization(x=b7, mean=moving_mean, variance=moving_variance, scale=gamma, variance_epsilon=bn_eps)
