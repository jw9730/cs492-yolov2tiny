    ...
    def build_graph(self, in_shape):
        ...
        with self.g.as_default():
            with tf.device(self.proc):
                ...
                n0 = tf.nn.batch_normalization(x=b0, mean=moving_mean, variance=moving_variance, offset=None, scale=gamma, variance_epsilon=1e-5)
                ...
                n1 = tf.nn.batch_normalization(x=b1, mean=moving_mean, variance=moving_variance, offset=None, scale=gamma, variance_epsilon=1e-5)
                ...
                n2 = tf.nn.batch_normalization(x=b2, mean=moving_mean, variance=moving_variance, offset=None, scale=gamma, variance_epsilon=1e-5)
                ...
                n3 = tf.nn.batch_normalization(x=b3, mean=moving_mean, variance=moving_variance, offset=None, scale=gamma, variance_epsilon=1e-5)
                ...
                n4 = tf.nn.batch_normalization(x=b4, mean=moving_mean, variance=moving_variance, offset=None, scale=gamma, variance_epsilon=1e-5)
                ...
                n5 = tf.nn.batch_normalization(x=b5, mean=moving_mean, variance=moving_variance, offset=None, scale=gamma, variance_epsilon=1e-5)
                ...
                n6 = tf.nn.batch_normalization(x=b6, mean=moving_mean, variance=moving_variance, offset=None, scale=gamma, variance_epsilon=1e-5)
                ...
                n7 = tf.nn.batch_normalization(x=b7, mean=moving_mean, variance=moving_variance, offset=None, scale=gamma, variance_epsilon=1e-5)
