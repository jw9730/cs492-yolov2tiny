            ...
            with tf.device('/' + self.proc):
                ...
                for i in range(len(w)):
                    ...
                    if 0 <= i < 6:
                        ...
                        n = tf.nn.batch_normalization(x=b, mean=moving_mean, variance=moving_variance, offset=biases, scale=gamma, variance_epsilon=1e-5, name="conv{}_batch_norm".format(i))
